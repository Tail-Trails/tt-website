    ...
    <div className="container mx-auto px-4 py-12">
      <div className="prose max-w-none">
        ...
        <ul>
          ...
          <li>
            <p>
              <strong>Application</strong> refers to Tail Trails Club, the
          ...
          <li>
            <p>
              ...
              "We", "Us" or "Our" in this Privacy Policy) refers to Tail
              Trails Club.
            </p>
          </li>
          <li>
        ...
        <ul>
          ...
          <li>Pictures and other information from your Device's camera and
          photo library</li>
        </ul>
        <p>
        ...
        <p>
          ...
          periods ("up to") and We may delete or anonymize data sooner when
          it is no longer needed for the relevant purpose. We apply different
        ...
        <ul>
          ...
          <li>
            ...
            <ul>
              ...
              <li>Chat transcripts: up to 24 months for quality assurance and
              staff training purposes.</li>
            </ul>
          </li>
          <li>
            <p>Usage Data</p>
        ...
        <p>We may retain Personal Data beyond the periods stated above for
        different reasons:</p>
        <ul>
        ...
        <ul>
          <li>By email: contact@tailtrails.club</li>
        </ul>

        <footer className="mt-8 text-sm text-muted-foreground">&copy; Tail Trails Club</footer>
      </div>
    </div>
  );
};
